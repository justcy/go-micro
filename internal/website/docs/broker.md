...
- HTTP (default)
- NATS (`go-micro.kanter.cn/v1/broker/nats`)
- RabbitMQ (`go-micro.kanter.cn/v1/broker/rabbitmq`)
- Memory (`go-micro.kanter.cn/v1/broker/memory`)

Plugins are scoped under `go-micro.kanter.cn/v1/broker/<plugin>`.
