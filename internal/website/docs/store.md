...
- Memory (default)
- File (`go-micro.kanter.cn/v1/store/file`)
- MySQL (`go-micro.kanter.cn/v1/store/mysql`)
- Postgres (`go-micro.kanter.cn/v1/store/postgres`)
- NATS JetStream KV (`go-micro.kanter.cn/v1/store/nats-js-kv`)

Plugins are scoped under `go-micro.kanter.cn/v1/store/<plugin>`.
